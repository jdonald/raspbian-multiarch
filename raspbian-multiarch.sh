...
sudo apt-get install -y libgcc1:arm64 gcc-6-base:arm64 libc6:arm64 ${PROTECTED_PACKAGES} # basic deps
sudo apt-get install -y libegl1-mesa-dev:arm64 libegl1-mesa:arm64 libwayland-egl1-mesa:arm64 libgbm1:arm64 ${PROTECTED_PACKAGES} # chocolate-doom:arm64 deps
...
sudo apt-get install -y libirrlicht1.8:arm64 libjsoncpp1:arm64 libleveldb1v5:arm64 liblua5.1-0:arm64 libopenal1:arm64 libstdc++6:arm64 libgl1-mesa-glx:arm64 libsndio6.1:arm64 libasound2:arm64 libglapi-mesa:arm64 libgl1-mesa-dri:arm64 libllvm3.9:arm64 python-imaging ${PROTECTED_PACKAGES} # minetest:arm64 deps
