...
sudo apt-get install -y libegl1-mesa-dev:arm64 libegl1-mesa:arm64 libwayland-egl1-mesa:arm64 libgbm1:arm64 mesa-common-dev:arm64 libglvnd-dev:arm64 libegl1:arm64 libgl1:arm64 libglx0:arm64 libdrm-dev:arm64 libdrm2:arm64 libdrm-radeon1:arm64 libdrm-nouveau2:arm64 libdrm-amdgpu1:arm64 libdrm-amdgpu1:arm64 libdrm-tegra0:arm64 libdrm-etnaviv1:arm64 libdrm-freedreno1:arm64 libegl-mesa0:arm64 libgbm1:arm64 ${PROTECTED_PACKAGES} # chocolate-doom:arm64 deps
